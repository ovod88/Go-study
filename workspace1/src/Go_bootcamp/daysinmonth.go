...
func main() {
	...
	if y%4 == 0 && m == "february" {
		fmt.Printf("%q has 28 days", m)
	} else if y%4 != 0 && m == "february" {
		fmt.Printf("%q has 29 days", m)
	} else if m == "january" || m == "may" || m == "may" ||
		m == "july" || m == "august" || m == "october" || m == "december" {
		fmt.Printf("%q has 31 days", m)
	} else if m == "april" || m == "june" || m == "september" || m == "november" {
		fmt.Printf("%q has 30 days", m)
	} else {
